...
local note: on this machine, herdr `0.7.0` reports ids like `w1`, `w1:t1`, and `w1:p1`. always use the ids returned by `herdr workspace list`, `herdr tab list`, and `herdr pane list`, not the literal example ids in this file.
